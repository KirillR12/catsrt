...
const createCard = function(cat, parent) {
	...
	if (cat.img_link) {
		...
		img.style.backgroundImage = "url(img/img_cats.png)";
...
createCard({name: "Матроские", img_link: ""}, container);
createCard({name: "Шолопай", img_link: "https://www.friendforpet.ru/api/sites/default/files/2022-01/%D0%BB%D0%B5%D0%B2%D0%B83_%D0%B0%D0%BB%D0%B5%D0%BA%D1%81.jpg"}, container);

fetch(`https://sb-cats.herokuapp.com/api/2/KirillR12/show`) 
	.then(res => res.json()) 
	.then(result => { 
